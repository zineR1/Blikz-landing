  ...
  return (
    <div className={styles.gral}>
        ...
        <div className={styles.texto}>
              <img src={icono1} alt="icono 1" height="200px"/>
        ...
        <div className={styles.texto}>
              <img src={icono2} alt="icono 2" height="200px"/>
        ...
        <div className={styles.mainContainer}>
        <div className={styles.texto}>
              <img src={icono3} alt="icono 1" height="200px"/>
        ...
        <div className={styles.texto}>
              <img src={icono4} alt="icono 2" height="200px"/>
